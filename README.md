...
Delivered actionable insights by solving 10 real-world business queries for AtliQ Hardware using structured SQL analysis across sales, products, and customer data. MySQL database, ERD interpretation, advanced SQL (CTEs, joins, window functions), data storytelling, and business segmentation. Improved customer segmentation accuracy by 25%, enhancing targeted marketing efforts.
