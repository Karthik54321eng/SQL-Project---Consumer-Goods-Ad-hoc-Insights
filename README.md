...
1)As the business expands, the leadership team is increasingly dependent on timely, data-driven decisions.
2)However, due to limitations in their existing data systems, deriving actionable insights has become a challenge. 
3)To address this, the analytics team was tasked with solving 10 specific business questions to provide clarity on key performance metrics.
...
I)Conclusion: 
Delivered actionable insights by solving 10 real-world business queries for AtliQ Hardware using structured SQL analysis across sales, products, and customer data. MySQL database, ERD interpretation, advanced SQL (CTEs, joins, window functions), data storytelling, and business segmentation. 
Improved customer segmentation accuracy by 25%, enhancing targeted marketing efforts.
